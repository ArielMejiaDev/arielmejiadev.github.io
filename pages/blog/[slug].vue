...
useSeoMeta({
  ...
  ogSiteName: 'Ariel Mejia Dev Blog',
    ...
    <div class="bg-white min-h-screen">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:max-w-4xl">
          ...
          <SocialShareButtons :title="data.title" :description="data.description" :url="`https://arielmejia.dev/blog/${data._path}`" twitter-username="@ArielMejiaDev" />
